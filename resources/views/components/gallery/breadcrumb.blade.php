<nav x-show="currentFolderId !== null" x-cloak class="flex items-center text-sm font-medium overflow-x-auto hide-scrollbar whitespace-nowrap bg-gray-50/50 p-2 rounded-lg border border-gray-100 mb-4">
